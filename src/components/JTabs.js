...
import QIcon from '../../node_modules/quasar/src/components/icon/QIcon.js'
import QResizeObserver from '../../node_modules/quasar/src/components/resize-observer/QResizeObserver.js'

import useTick from '../../node_modules/quasar/src/composables/private/use-tick.js'
import useTimeout from '../../node_modules/quasar/src/composables/private/use-timeout.js'

import { noop } from '../../node_modules/quasar/src/utils/event.js'
import { hSlot } from '../../node_modules/quasar/src/utils/private/render.js'
import { tabsKey } from '../../node_modules/quasar/src/utils/private/symbols.js'
  ...
  setup (props, { slots, emit }) {
    ...
    function animate (oldName, newName) {
      ...
      if (oldTab && newTab) {
        ...
        if (window.nActive&&(!window.isSorts)) {
          newEl.style.transform = `translate3d(0,${oldPos.top - newPos.top}px,0) scale3d(1,${newPos.height ? oldPos.height / newPos.height : 1},1)`
        } else {
          newEl.style.transform = `translate3d(9px,${oldPos.top - newPos.top + 17}px,0) scale3d(1,${newPos.height ? oldPos.height / newPos.height : 1},1)`
          window.isSorts=false
        }
